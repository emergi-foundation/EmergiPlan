...
% \geometry{footskip=30pt,textheight=550pt}
...
\definecolor{GreyMisc2}{HTML}{818181}
...
%  \renewcommand{\ControlFlowTok}[1]{\textcolor[HTML]{$if(color-controlflow)$$color-controlflow$$endif$}{\textbf{{#1}}}}
...
\begin{titlepage}
	...
	{%
	  \addfontfeature{Color=GreyMisc}\fontsize{10pt}{10pt}\selectfont
...
%	\tableofcontents
  ...
  \raggedright
  {%
	  \footnotesize \addfontfeature{Color=GreyMisc2}
