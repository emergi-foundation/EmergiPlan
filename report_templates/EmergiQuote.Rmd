...
#daily_pct for september
daily_pct_sept <- .0028080
...
avg_use <- (params$last_bill_kWh/(days_passed-1))

#energy used per day divided by daily_pct
implied_annual <- avg_use/daily_pct_sept
...
monthly <- round(yearly_total / 12, 0)
monthly_ceiling <- round(monthly, -2)
